...
- [Postwork Fase 02 Módulo 02 Sesión 04 - Descripción ](#sesion04-description)
  ...
  - [Routes](#Routes)
    - [categoria](#categoria_route)
    - [pedido](#pedido_route)
    - [producto](#producto_route)
    - [usuario](#usuario_route)
  - [Ejemplos](#Examples)
    - [categoria](#categoria_example)
      - [Nuevo](#categoria_example_new)
      - [Ver todos](#categoria_example_getAll)
      - [Ver por ID](#categoria_example_getById)
      - [Editar](#categoria_example_edit)
      - [Cambiar Estatus](#categoria_example_changeStatus)
      - [Filtrar](#categoria_example_filter)
...
<a name="categoria_model"></a>

#### categoria

```js
class Categoria {
  constructor({ id, name, description, estatus }) {
    this.id = id;
    this.name = name;
...
```js
class Producto {
  constructor({ id, name, idCategoria, description, cost, estatus }) {
    this.id = id;
    this.name = name;
...
```js
class Usuario {
  constructor({ id, name, correo, password, tipo, estatus }) {
    this.id = id;
    this.name = name;
    this.correo = correo;
...
router.put("/cambiarTipo", cambiarRol);
...
<a name="categoria_example"></a>

#### categoria

---

<a name="categoria_example_new"></a>
...
```json
{
  ...
  "description": "Es la cat de Comidas rápidas",
  "estatus": 1
}
```
...
```json
{
  "id": 1,
  "name": "Jugos",
  "description": "Es la cat de Jugos",
  "estatus": 0
}
```
...
<a name="categoria_example_changeStatus"></a>

##### Cambiar Estatus

`PUT: http://localhost:3000/v1/categoria/cambiarEstatus`
...
<a name="categoria_example_filter"></a>

##### Filtrar

`POST: http://localhost:3000/v1/categoria/filtrar/`
...
`PUT: http://localhost:3000/v1/usuarios/cambiarEstatus`
...
`PUT: http://localhost:3000/v1/usuarios/cambiarTipo`
