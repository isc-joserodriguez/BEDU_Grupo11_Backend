...
//Productos ejemplo
var PRODUCTOS = [new Producto({id:1, nombre:'Chilaquiles', id_categoria:1, descripcion:'Chilaquiles con pollo en salsa verde y queso doble crema', costo: 75, estatus:1}),
...
function eliminarProducto(req,res) {
    ...
    for(let i=0; i<PRODUCTOS.length;i++){           //Para cada elemento dentro del arreglo
     ...
     if(productoEncontrado) {(res.status(200).send(productoEncontrado))} //Mensaje producto eliminado
